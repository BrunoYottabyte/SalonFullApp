        ...
        <div className="col-12">
          ...
          <TableComponent
            ...
            config={[
              ...
              { label: "Sexo", content: (item) => item.sexo === "M" ? 'Masculino' : 'Feminino', width: 200 },
              { label: "data Cadastro", content: (item) => moment(item.dataCadastro).format('YYYY/MM/DD - HH:mm'), width: 200 },
            ]}
            actions={(cliente) => (
